...
/**
 * Factura
 * @ORM\Entity(repositoryClass="FactelBundle\Entity\Repository\ProformaRepository")
 */
class Proforma {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Cliente", inversedBy="proformas")
     * @ORM\JoinColumn(name="cliente_id", referencedColumnName="id", nullable=false)
     */
    protected $cliente;

    /**
     * @ORM\ManyToOne(targetEntity="Emisor", inversedBy="proformas")
     * @ORM\JoinColumn(name="emisor_id", referencedColumnName="id", nullable=false)
     */
    protected $emisor;

    /**
     * @ORM\ManyToOne(targetEntity="Establecimiento", inversedBy="proformas")
     * @ORM\JoinColumn(name="establecimiento_id", referencedColumnName="id", nullable=false)
     */
    protected $establecimiento;
    
    /**
     * @ORM\OneToMany(targetEntity="CampoAdicional", mappedBy="proforma", cascade={"persist"})
     */
    protected $composAdic;

    /**
     * @ORM\OneToMany(targetEntity="ProformaHasProducto", mappedBy="proforma", cascade={"persist"})
     */
    protected $proformasHasProducto;

    /**
     * @ORM\OneToMany(targetEntity="Mensaje", mappedBy="proforma")
     */
    protected $mensajes;

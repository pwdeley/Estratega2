...
class Establecimiento {
    ...
    /**
     * @ORM\OneToMany(targetEntity="Proforma", mappedBy="establecimiento")
     */
    protected $proformas;


    /**
     * @ORM\OneToMany(targetEntity="Compra", mappedBy="establecimiento")
     */
    protected $compras;
    /**
     * @ORM\OneToMany(targetEntity="LiquidacionCompra", mappedBy="establecimiento")
     */
     ...
     * @var string
     *
     * @ORM\Column(name="emailCopia", type="string", length=300, nullable=TRUE)
     */
    protected $emailCopia;
     ...
     * @var string
     *
     * @ORM\Column(name="secuencialProforma", type="integer")
     */
    protected $secuencialProforma = 1;
    ...
    /**
     * Set secuencialProforma
     *
     * @param integer $secuencialProforma
     *
     * @return Establecimiento
     */
    public function setSecuencialProforma($secuencialProforma)
    {
        $this->secuencialProforma = $secuencialProforma;

        return $this;
    }

    /**
     * Get secuencialProforma
     *
     * @return integer
     */
    public function getSecuencialProforma()
    {
        return $this->secuencialProforma;
    }
}

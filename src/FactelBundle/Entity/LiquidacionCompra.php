...
class LiquidacionCompra {
     ...
     * Add reembolso
     *
     * @param \FactelBundle\Entity\LiquidacionCompraReembolso $reembolso
     *
     * @return LiquidacionCompra
     */
    public function addReembolso(\FactelBundle\Entity\LiquidacionCompraReembolso $reembolso)
    {
     ...
     * @param \FactelBundle\Entity\LiquidacionCompraReembolso $reembolso
     */
    public function removeReembolso(\FactelBundle\Entity\LiquidacionCompraReembolso $reembolso)
    {

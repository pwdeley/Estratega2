...
<form class="form-inline" method="post" name="xmlForm" id="xmlForm" enctype="multipart/form-data">
    ...
    <div class="col-xs-6 col-xs-offset-4">
        <div class="form-group">
            <label for="input_factura">Seleccionar Factura de Venta:  </label>
...
<div class="col-xs-18 col-xs-offset-1">
    <h3>Listado de Ventas Electrónicas:</h3><br>
